...
- **menu bar agent** - минималистичный глиф скрепыша в трее, всё управление там
- **где показывать** - трей и/или иконка в доке (по умолчанию оба); в режиме
  дока настройки открываются окном (Cmd+,)
